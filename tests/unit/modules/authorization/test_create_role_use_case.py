...
async def test_create_role_persists_role(role_repository, unit_of_work, audit_log_repository) -> None:
...
async def test_create_role_with_duplicate_name_raises_error(role_repository, unit_of_work, audit_log_repository) -> None:
    use_case = CreateRoleUseCase(role_repository, unit_of_work, audit_log_repository)
