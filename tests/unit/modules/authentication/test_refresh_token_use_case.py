...
def _build_use_case(refresh_token_repository, session_repository, token_service, clock, unit_of_work) -> RefreshTokenUseCase:
...
async def test_refresh_with_unknown_token_raises_invalid_refresh_token(
    refresh_token_repository, session_repository, token_service, clock, unit_of_work
) -> None:
    use_case = _build_use_case(refresh_token_repository, session_repository, token_service, clock, unit_of_work)
